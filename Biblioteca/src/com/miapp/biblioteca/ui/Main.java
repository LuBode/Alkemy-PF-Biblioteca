...
public class Main {
    public static void main(String[] args) {
		...
		UsuarioServicio usuarioServicio = new UsuarioServicio(usuario);
                ...
                Libro libro1 = new Libro("Una Corte de Rosas y Espinas", 
                        "Sarah J. Maas", "9789504974574", "Fantasia");
                Libro libro2 = new Libro("Una Corte de Niebla y Furia",
                        "Sarah J. Maas", "9788408257110", "Fantasia");
                Libro libro3 = new Libro("Una Corte de Alas y Ruinas",
                        "Sarah J. Maas", "9788408257127", "Fantasia");
                
                Usuario usuario1 = new Usuario("Lu Bode", "44384739");
                biblioteca.add(libro1);
                biblioteca.add(libro2);
                biblioteca.add(libro3);
                usuario1.setLibrosPrestados(biblioteca);
                
                Usuario usuario2 = new Usuario("Nahue Sequeira", "37284625");
                Usuario usuario3 = new Usuario("Giane Orduña", "44401587");
